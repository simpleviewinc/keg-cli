...
Labels: None
Alpha:
	URL: /Users/mutagen/keg/keg-core
	Connection state: Connected
Beta:
	URL: docker://89081a36b44d/keg/keg-core
		DOCKER_HOST=tcp://192.168.99.101:2376
		DOCKER_TLS_VERIFY=1
		DOCKER_CERT_PATH=/Users/mutagen/.docker/machine/machines/docker-keg
		DOCKER_API_VERSION=
	Connection state: Connected
...
Labels: None
Alpha:
	URL: /Users/mutagen/keg/keg-components
	Connection state: Connected
Beta:
...
const listObjOutput = [
  {
    ...
    beta: {
      ...
      dockerTlsVerify: '1',
      dockerCertPath: '/Users/mutagen/.docker/machine/machines/docker-keg',
      connectionState: 'Connected'
    },
    status: 'Watching for changes'
  },
