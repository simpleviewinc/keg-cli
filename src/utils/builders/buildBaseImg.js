...
const buildBaseImg = async args => {
  ...
  const imgNameContext = exists && getImgNameContext(args.params)
  
  if(imgNameContext.tag && checkMatchingTag(exists, imgNameContext.tag)) return true
