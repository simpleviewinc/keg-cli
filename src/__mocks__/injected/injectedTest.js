...
const injectedTest = {
  ...
  contextEnvs: {
    ...
    EXPO_APP_PORT: '19006',
    GIT_KEY: 'INITIAL',
    GIT_CLI_URL: 'https://github.com/lancetipton/.git',
    GIT_CORE_URL: 'https://github.com/lancetipton/.git',
    GIT_COMPONENTS_URL: 'https://github.com/lancetipton/.git',
    GIT_RESOLVER_URL: 'https://github.com/lancetipton/.git',
    GIT_PROXY_URL: 'https://github.com/lancetipton/.git',
